...
/*
examples::sage::stable::example_02_01
    examples::sage::stable::example_02_02
    examples::sage::stable::example_02_03
    examples::sage::stable::example_02_04
    examples::sage::stable::example_02_05
    examples::sage::stable::example_02_06
    examples::sage::stable::example_02_07
    examples::sage::stable::example_02_08
    examples::sage::stable::example_05_10
    examples::sage::stable::example_06_15
*/
...
[
    Dawn,
    NodeSequence(Id { level: 0, parent: 0, index: 2 }, None, Static("tag:yaml.org,2002:seq")),
    NodeScalar(Id { level: 1, parent: 2, index: 3 }, None, Str(StrValue { style: 0, alias: None, value: String("Mark McGwire") })),
    NodeScalar(Id { level: 1, parent: 2, index: 5 }, None, Str(StrValue { style: 0, alias: None, value: String("Ken Griffey") })),
    NodeScalar(Id { level: 1, parent: 2, index: 4 }, None, Str(StrValue { style: 0, alias: None, value: String("Sammy Sosa") })),
    Dusk,
    Dusk,
    Done,
    Done
